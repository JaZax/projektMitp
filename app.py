...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.inputHat.setItemData(4, fr"img\hatBusiness.png")
        self.inputHat.setItemData(5, fr"img\hatRockman.png")
        self.inputHat.setItemData(6, fr"img\hatGoth.png")
        self.inputHat.setItemData(7, fr"img\hatSummer.png")
        self.inputHat.setItemData(8, fr"img\hatWiking.png")
        self.inputHat.setItemData(9, fr"img\hatHero.png")
        self.inputHat.setItemData(10, fr"img\hatPrison.png")
        ...
        self.inputBody.setItemData(4, fr"img\bodyBusiness.png")
        self.inputBody.setItemData(5, fr"img\bodyRockman.png")
        self.inputBody.setItemData(6, fr"img\bodyGoth.png")
        self.inputBody.setItemData(7, fr"img\bodySummer.png")
        self.inputBody.setItemData(8, fr"img\bodyWiking.png")
        self.inputBody.setItemData(9, fr"img\bodyHero.png")
        self.inputBody.setItemData(10, fr"img\bodyPrison.png")
        ...
        self.inputAccessory.setItemData(4, fr"img\accessoryBusiness.png")
        self.inputAccessory.setItemData(5, fr"img\accessoryRockman.png")
        self.inputAccessory.setItemData(6, fr"img\accessoryGoth.png")
        self.inputAccessory.setItemData(7, fr"img\accessorySummer.png")
        self.inputAccessory.setItemData(8, fr"img\accessoryWiking.png")
        self.inputAccessory.setItemData(9, fr"img\accessoryHero.png")
        self.inputAccessory.setItemData(10, fr"img\accessoryPrison.png")

        self.inputBackground.setItemData(0, fr"img\frontBg1.png")
        self.inputBackground.setItemData(1, fr"img\frontBg2.png")
        self.inputBackground.setItemData(2, fr"img\frontBg3.png")
